...
class TestTushareIntegration:
    ...
    - 000001.SZ: open=11.15, high=11.32, low=11.13, close=11.27, vol=1148895.22, amount=1292756.712
    - 600000.SH: open=10.25, high=10.37, low=10.21, close=10.25, vol=416383.22, amount=427990.04
    """
    ...
    def test_get_bar(self):
        ...
        # 深圳 000001.SZ
        df_sz = self.source.get_bar("000001.SZ", "1d", "20260402", "20260402")
        row_sz = df_sz.iloc[0]
        ...
        # 上海 600000.SH
        df_sh = self.source.get_bar("600000.SH", "1d", "20260402", "20260402")
        row_sh = df_sh.iloc[0]
